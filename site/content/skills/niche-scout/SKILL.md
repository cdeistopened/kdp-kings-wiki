...
- `niche-validation-pipeline.md` — The full validation methodology this skill implements (3-step framework from Chesson, Dollwet, Roberts)
- `kdp-revenue-map.md` — Understand revenue potential across formats before committing to a niche
